...
#endif /* CONFIG_STA_SUPPORT */
				RefFreqOffset = pAd->RfFreqOffset;
	...
	IN PRTMP_ADAPTER pAd)
{
	...
	RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, 158, 0x00);
	RTMP_BBP_IO_WRITE8_BY_REG_ID(pAd, 159, 0x80);

	/* Check re-calibarate BBP IQ done. */
	do
	{
		RTMP_BBP_IO_READ8_BY_REG_ID(pAd, 159, &BBPValue);	
		RTMPusecDelay(5);
